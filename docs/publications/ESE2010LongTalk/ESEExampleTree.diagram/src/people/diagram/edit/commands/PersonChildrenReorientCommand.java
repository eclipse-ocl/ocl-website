...
import people.diagram.edit.policies.PeopleBaseItemSemanticEditPolicy;

/**
 * @generated
 */
public class PersonChildrenReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PersonChildrenReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return PeopleBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPersonChildren_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return PeopleBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPersonChildren_4002(getOldSource(), getNewTarget());
	}
