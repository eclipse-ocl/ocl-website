...
public class PersonEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(PeopleElementTypes.PersonChildren_4002);
		return types;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof people.diagram.edit.parts.PersonEditPart) {
			types.add(PeopleElementTypes.PersonChildren_4002);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == PeopleElementTypes.PersonChildren_4002) {
